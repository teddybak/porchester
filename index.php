  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top"> 
        <img src="img/porchester.png" width="25%" height="25%" class="rounded-circle" alt="Cinque Terre">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">First Hand Experience</span><strong class="text-slider"></strong></p>
